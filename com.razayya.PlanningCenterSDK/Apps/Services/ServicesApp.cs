...
using com.razayya.PlanningCenterSDK.Apps.Services.Endpoints;
using com.razayya.PlanningCenterSDK.Http;

namespace com.razayya.PlanningCenterSDK.Apps.Services
{
    public class ServicesApp
    {
        ...
        public PlanPersonEndpoint PlanPerson { get; }
        public ServiceTypeEndpoint ServiceType { get; }
        public TeamEndpoint Team { get; }

        public static ServicesApp GetInstance( string applicationId, string secret, int rateLimitPer10s,  int rateLimitPer10m )
        {
            return null;
        }
        ...
        private ServicesApp( string applicationId, string secret, IDictionary<TimeSpan, int> rateLimits )
        {
            ...
            PlanPerson = new PlanPersonEndpoint( requester );

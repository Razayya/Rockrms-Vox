...
namespace RockWeb.Plugins.com_razayya.JourneyTrack
{
    ...
    public partial class JourneyProgramList : RockBlock, ICustomGridColumns
    {
        ...
        {
            NavigateToLinkedPage( "DetailPage", "JourneyProgramId", 0 );
        }

        protected void gList_RowSelected( object sender, RowEventArgs e )
        {
            NavigateToLinkedPage( "DetailPage", "JourneyProgramId", e.RowKeyId );
        }

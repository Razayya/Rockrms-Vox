<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CalculationRunList.ascx.cs"
    Inherits="RockWeb.Plugins.com_razayya.CustomPersonAttributeSyncEngine.CalculationRunList" %>

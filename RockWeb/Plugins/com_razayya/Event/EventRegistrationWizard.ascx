<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EventRegistrationWizard.ascx.cs" Inherits="RockWeb.Plugins.com_razayya.Blocks.Event.EventRegistrationWizard" %>
                ...
                <div class="panel-body">
                    ...
                    <asp:Panel ID="pnlInitiate" runat="server">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:PlaceHolder ID="phRegistrationTemplateHelpText" runat="server" />
                                </div>
                            </div>
                            <%-- UI2.End --%>
                            <div class="row">
                                <div class="col-md-6">
                                    <%-- UI1.Start --%>
                                    <Rock:RegistrationTemplatePicker ID="rtpTemplate" Label="Registration Template" runat="server" Visible="false" OnSelectItem="rtpTemplate_SelectItem" />
                                    <%-- UI1.End --%>
                    ...
                    <asp:Panel ID="pnlRegistration" runat="server" Visible="false">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:PlaceHolder ID="phRegistrationHelpText" runat="server" />
                                </div>
                            </div>
                            <%-- UI2.End --%>
                            <div class="row">
                    ...
                    <asp:Panel ID="pnlGroup" runat="server" Visible="false">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:PlaceHolder ID="phGroupHelpText" runat="server" />
                                </div>
                            </div>
                            <%-- UI2.End --%>

                            <%  /* FE1.Start */
                                if ( GetAttributeValue( CustomAttributeKey.AllowSelectingAnExistingGroup ) == "True" )
                                { %>
                            <div class="row">
                                <div class="col-md-12">
                                    <Rock:Toggle ID="toggleExistingGroup" runat="server"
                                        Label="Select Existing Group" OnText="Yes" OffText="No" Checked="true"
                                        OnCheckedChanged="toggleExistingGroup_CheckedChanged" />
                                    <hr />
                                </div>
                            </div>
                            <asp:Panel ID="pnlExistingGroup" runat="server" Visible="true">
                                <div class="row">
                                    <div class="col-md-6">
                                        <Rock:GroupPicker ID="gpGroup" runat="server" Label="Select a Group" OnSelectItem="gpGroup_SelectItem" />
                                    </div>
                                </div>
                            </asp:Panel>
                            <% } //Add an ASP pannel to the New Group Controls to allow hiding it. %>
                            <asp:Panel ID="pnlNewGroup" runat="server" Visable="false">
                                <div class="row">
                                    <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <Rock:GroupPicker ID="gpParentGroup" runat="server" Label="Parent Group" OnSelectItem="gpParentGroup_SelectItem" Required="true" />
                                    </div>
                                </div>
                            </asp:Panel>
                            <% // FE1.END %>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <% // FE5.Start %>
                                    <Rock:NotificationBox ID="nbGroupLocationTypeNotPermitted" runat="server" NotificationBoxType="Danger" Visible="false" Heading="Location Type Not Permitted">
                    ...
                    <asp:Panel ID="pnlEvent" runat="server" Visible="false">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:PlaceHolder ID="phEventHelpText" runat="server" />
                                </div>
                            </div>
                            <%-- UI2.End --%>
                    ...
                    <asp:Panel ID="pnlEventOccurrence" runat="server" Visible="false">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:PlaceHolder ID="phEventOccurrenceHelpText" runat="server" />
                                </div>
                            </div>
                            <%-- UI2.End --%>
                            <%  /* FE2.Start */
                                if ( GetAttributeValue( CustomAttributeKey.AllowSelectingAnExistingEventOccurrence ) == "True" )
                                { %>
                            <div class="row">
                                <div class="col-md-12">
                    ...
                    <asp:Panel ID="pnlFinished" runat="server" Visible="false">
                        <div class="alert alert-success">
                            ...
                            <ul>
                                ...
                                <!-- FE3.Start -->
                                <li id="liReservationLink" runat="server">
                                    <asp:HyperLink ID="hlReservation" runat="server" Text="View Reservation" /></li>
                                <!-- FE3.End -->
                            </ul>
                        </div>
                        <!-- FE4.Start -->
                        <% if ( GetAttributeValue( CustomAttributeKey.ShowNewButton ) == "True" )
                            { %>
                        <fieldset>
                            <div class="actions">
                                <asp:LinkButton ID="lbNew" runat="server" AccessKey="n" Text="Replicate" DataLoadingText="Replicate" CssClass="btn btn-link pull-right js-wizard-navigation" CausesValidation="false" OnClick="lbNew_Click" />
                            </div>
                        </fieldset>
                        <% } %>
                        <!-- FE4.End -->

...
{
    /// <summary>
    /// Portable export format for a CalculationGroup and all its children.
    /// Uses GUIDs and keys (not IDs) so the export is portable between Rock instances.
    /// </summary>
    public class CalculationGroupExport
    {
        ...
        public List<CalculationSubGroupExport> SubGroups { get; set; } = new List<CalculationSubGroupExport>();
    }

    /// <summary>
    /// Portable export format for a CalculationSubGroup and its Calculations.
    /// </summary>
    public class CalculationSubGroupExport
    {
        public string Name { get; set; }
        public string Description { get; set; }
        public bool IsActive { get; set; }
        ...
        public List<CalculationExport> Calculations { get; set; } = new List<CalculationExport>();
    }

    /// <summary>
    /// Portable export format for a Calculation and its component attributes.
    /// </summary>
    public class CalculationExport
    {
        public string Name { get; set; }
        public string Description { get; set; }
        public bool IsActive { get; set; }
